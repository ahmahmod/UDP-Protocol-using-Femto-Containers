...
file_paths = [
    'rx_filtered_FCgnrc_time.txt',
    'rx_filtered_fc_time.txt',
    'rx_filtered_GNRCfc_time.txt',
    'rx_filtered_gnrc_time.txt'
]
...
plt.title('UDP Reception Execution Time', fontsize=16)
plt.legend(fontsize=14)
plt.grid(True)

plt.tight_layout()
plt.savefig('rx_packets.pdf', format='pdf', dpi=2000, bbox_inches='tight')
plt.savefig('rx_packets.png', format='png', dpi=2000, bbox_inches='tight')
plt.savefig('rx_packets.svg', format='svg', dpi=2000, bbox_inches='tight')
plt.show()
